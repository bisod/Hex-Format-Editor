...
export class HexEditorProvider implements vscode.CustomEditorProvider<HexDocument> {
  ...
  private static readonly viewType = "formatEditor.hexedit";
  ...
  private async onMessage(
    ...
    switch (message.type) {
      ...
      case MessageType.UpdateEditorSettings:
        ...
        break;
      case MessageType.ShowWarningMessage:
        vscode.window.showInformationMessage(message.warnning);
        break;
    }
  }
